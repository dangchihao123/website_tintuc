...
<div class="thongtin-content">
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1000px; height: 150px; overflow: hidden;">
        ...
        $quangcao_footer = $top->quangcao(2);
        while($row_quangcao_duoi = mysqli_fetch_array($quangcao_footer)){
        ?>   
        <div><img u="image" src="upload/quangcao/<?php echo $row_quangcao_duoi["urlHinh"]?>" /></div>
        <?php
        }
        ?>   
        </div>
